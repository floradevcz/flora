...
import { BookOpen, Camera, House, Leaf, Settings } from "lucide-react";
import Link from "next/link";
import { usePathname } from "next/navigation";

const items = [{ href: "/", icon: House, label: "Domů" }, { href: "/atlas", icon: BookOpen, label: "Atlas" }, { href: "/my-plants", icon: Leaf, label: "Moje rostliny" }, { href: "/floragram", icon: Camera, label: "FloraGram" }, { href: "/settings", icon: Settings, label: "Nastavení" }];
